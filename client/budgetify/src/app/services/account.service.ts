...
import IAccounts from '../todo/models/Accounts';
...
export class AccountService {
  ...
  activeAccount$ = new BehaviorSubject<IAccounts>(this.activeAccount);
  accounts$ = new BehaviorSubject<IAccounts[]>([...this.accounts]);
  constructor(private http:HttpClient) {}

  getAccounts(){
    return this.http.get<IAccounts[]>(`${this.baseUrl}/account`).pipe(tap((accounts)=>{
